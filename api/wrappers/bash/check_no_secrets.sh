...
# PATH: /api/wrappers/bash/check_no_secrets.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_no_secrets.php

set -euo pipefail

SCRIPT_NAME="check_no_secrets"
SCRIPT_PATH="api/validate/check_no_secrets.php"
