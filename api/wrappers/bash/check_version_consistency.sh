...
# PATH: /api/wrappers/bash/check_version_consistency.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_version_consistency.php

set -euo pipefail

SCRIPT_NAME="check_version_consistency"
SCRIPT_PATH="api/validate/check_version_consistency.php"
