...
$ScriptName = "auto_create_org_projects"
$ScriptPath = "scripts/automation/auto_create_org_projects.py"
$ScriptCategory = "automation"  # automation, validation, maintenance, etc.
