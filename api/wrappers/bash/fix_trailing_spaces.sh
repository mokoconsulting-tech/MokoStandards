...
# PATH: /api/wrappers/bash/fix_trailing_spaces.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/fix/fix_trailing_spaces.php

set -euo pipefail

SCRIPT_NAME="fix_trailing_spaces"
SCRIPT_PATH="api/fix/fix_trailing_spaces.php"
SCRIPT_CATEGORY="fix"
