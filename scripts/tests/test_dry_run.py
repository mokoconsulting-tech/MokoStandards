...
CANONICAL_DOCUMENTS = {
    ...
    "docs/guide/waas/waas-architecture.md": {"type": "guide", "subtype": "waas", "priority": "Medium", "approval": "No"},
    "docs/guide/waas/waas-operations.md": {"type": "guide", "subtype": "waas", "priority": "Medium", "approval": "No"},
    "docs/guide/waas/waas-client-onboarding.md": {"type": "guide", "subtype": "waas", "priority": "Medium", "approval": "No"},
