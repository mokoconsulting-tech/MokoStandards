...
# PATH: /api/wrappers/bash/pin_action_shas.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/maintenance/pin_action_shas.php

set -euo pipefail

SCRIPT_NAME="pin_action_shas"
SCRIPT_PATH="api/maintenance/pin_action_shas.php"
