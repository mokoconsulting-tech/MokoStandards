...
# PATH: /api/wrappers/bash/auto_detect_platform.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/auto_detect_platform.php

set -euo pipefail

SCRIPT_NAME="auto_detect_platform"
SCRIPT_PATH="api/validate/auto_detect_platform.php"
