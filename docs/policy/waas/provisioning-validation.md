...
This policy defines mandatory validation and acceptance requirements that must be satisfied before any Website as a Service client site is considered provisioned and eligible for client access or production use.

The objective is to prevent unlicensed, unmonitored, insecure, or non compliant sites from entering service.
...
The following conditions must be validated:
...
* Platform and extension versions match approved baselines

### Licensing and Site Key Validation
...
* Site is registered in Panopticon at waas.mokoconsulting.tech
* Monitoring status reporting is active
...
This policy is enforced through provisioning workflows, automation control gates, and periodic governance audits.

Non compliance results in blocked delivery until remediation is complete.

## Metadata

* **STANDARD TYPE**: Policy
* **APPLIES TO**: WaaS provisioning events
