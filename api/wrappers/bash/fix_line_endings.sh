...
# PATH: /api/wrappers/bash/fix_line_endings.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/fix/fix_line_endings.php

set -euo pipefail

SCRIPT_NAME="fix_line_endings"
SCRIPT_PATH="api/fix/fix_line_endings.php"
SCRIPT_CATEGORY="fix"
