...
<repository-structure xmlns="http://mokoconsulting.com/schemas/repository-structure"
  ...
  <metadata>
    ...
    <description>Standard repository structure for generic projects and libraries</description>
  ...
  <structure>
    ...
    <root-files>
      ...
      <file extension="gitignore">
        ...
        <template>templates/configs/.gitignore.generic</template>
      </file>
    ...
    <directories>
      ...
      <directory path="src">
        ...
        <requirement-status>suggested</requirement-status>
        <purpose>Contains application/library source code</purpose>
      </directory>
      ...
      <directory path="docs">
        ...
        <required>true</required>
        <purpose>Contains comprehensive documentation</purpose>
      ...
      <directory path=".github">
        ...
        <subdirectories>
          ...
          <directory path=".github/ISSUE_TEMPLATE">
            ...
            <description>GitHub issue templates</description>
            <requirement-status>suggested</requirement-status>
          </directory>
        </subdirectories>
      </directory>
