...
# PATH: /api/wrappers/bash/check_joomla_manifest.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_joomla_manifest.php

set -euo pipefail

SCRIPT_NAME="check_joomla_manifest"
SCRIPT_PATH="api/validate/check_joomla_manifest.php"
