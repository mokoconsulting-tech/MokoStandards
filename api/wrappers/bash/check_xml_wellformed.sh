...
# PATH: /api/wrappers/bash/check_xml_wellformed.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_xml_wellformed.php

set -euo pipefail

SCRIPT_NAME="check_xml_wellformed"
SCRIPT_PATH="api/validate/check_xml_wellformed.php"
