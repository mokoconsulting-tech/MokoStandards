...
# PATH: /api/wrappers/bash/fix_permissions.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/fix/fix_permissions.php

set -euo pipefail

SCRIPT_NAME="fix_permissions"
SCRIPT_PATH="api/fix/fix_permissions.php"
SCRIPT_CATEGORY="fix"
