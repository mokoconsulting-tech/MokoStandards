...
**You are here:** Documentation -> Onboarding Guide
...
New team members must receive:

* Platform accounts
* Repository access
* Documentation portal access
* Required credentials via secure channels
...
New members must complete basic training covering:
