...
# PATH: /api/wrappers/bash/setup_labels.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/maintenance/setup_labels.php

set -euo pipefail

SCRIPT_NAME="setup_labels"
SCRIPT_PATH="api/maintenance/setup_labels.php"
