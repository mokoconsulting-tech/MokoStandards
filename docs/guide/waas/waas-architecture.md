...
- Infrastructure and application architecture documented
- Network and data architecture defined
- Scalability, high availability, and disaster recovery architecture specified
