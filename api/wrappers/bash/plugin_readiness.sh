...
# PATH: /api/wrappers/bash/plugin_readiness.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/plugin_readiness.php

set -euo pipefail

SCRIPT_NAME="plugin_readiness"
SCRIPT_PATH="api/plugin_readiness.php"
