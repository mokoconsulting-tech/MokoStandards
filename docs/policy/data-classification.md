...
- Classification levels and criteria defined
- Access control and handling requirements documented
- Storage, transmission, and retention requirements specified
