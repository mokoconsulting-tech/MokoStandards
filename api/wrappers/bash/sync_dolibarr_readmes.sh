...
# PATH: /api/wrappers/bash/sync_dolibarr_readmes.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/maintenance/sync_dolibarr_readmes.php

set -euo pipefail

SCRIPT_NAME="sync_dolibarr_readmes"
SCRIPT_PATH="api/maintenance/sync_dolibarr_readmes.php"
