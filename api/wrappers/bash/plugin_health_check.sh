...
# PATH: /api/wrappers/bash/plugin_health_check.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/plugin_health_check.php

set -euo pipefail

SCRIPT_NAME="plugin_health_check"
SCRIPT_PATH="api/plugin_health_check.php"
SCRIPT_CATEGORY="plugin"
