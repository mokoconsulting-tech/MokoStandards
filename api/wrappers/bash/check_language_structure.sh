...
# PATH: /api/wrappers/bash/check_language_structure.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_language_structure.php

set -euo pipefail

SCRIPT_NAME="check_language_structure"
SCRIPT_PATH="api/validate/check_language_structure.php"
