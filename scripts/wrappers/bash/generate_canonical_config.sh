...
SCRIPT_NAME="generate_canonical_config"
SCRIPT_PATH="scripts/analysis/generate_canonical_config.py"
SCRIPT_CATEGORY="analysis"  # automation, validation, maintenance, etc.
