...
# PATH: /api/wrappers/bash/check_structure.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_structure.php

set -euo pipefail

SCRIPT_NAME="check_structure"
SCRIPT_PATH="api/validate/check_structure.php"
