...
```markdown
![MokoStandards](https://img.shields.io/badge/MokoStandards-04.00.03-blue)
```

**Renders as**: ![MokoStandards](https://img.shields.io/badge/MokoStandards-04.00.03-blue)
...
**Renders as**: [![MokoStandards](https://img.shields.io/badge/MokoStandards-04.00.03-blue)](https://github.com/mokoconsulting-tech/MokoStandards)
...
```markdown
![MokoStandards](https://img.shields.io/badge/MokoStandards-04.00.03-blue?style=flat-square)
```
