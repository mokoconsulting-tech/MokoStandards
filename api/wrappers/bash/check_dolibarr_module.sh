...
# PATH: /api/wrappers/bash/check_dolibarr_module.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_dolibarr_module.php

set -euo pipefail

SCRIPT_NAME="check_dolibarr_module"
SCRIPT_PATH="api/validate/check_dolibarr_module.php"
