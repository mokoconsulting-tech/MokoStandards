...
# PATH: /api/wrappers/bash/check_php_syntax.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_php_syntax.php

set -euo pipefail

SCRIPT_NAME="check_php_syntax"
SCRIPT_PATH="api/validate/check_php_syntax.php"
