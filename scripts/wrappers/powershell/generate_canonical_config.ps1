...
$ScriptName = "generate_canonical_config"
$ScriptPath = "scripts/analysis/generate_canonical_config.py"
$ScriptCategory = "analysis"  # automation, validation, maintenance, etc.
