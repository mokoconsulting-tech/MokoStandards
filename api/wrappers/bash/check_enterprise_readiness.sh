...
# PATH: /api/wrappers/bash/check_enterprise_readiness.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_enterprise_readiness.php

set -euo pipefail

SCRIPT_NAME="check_enterprise_readiness"
SCRIPT_PATH="api/validate/check_enterprise_readiness.php"
