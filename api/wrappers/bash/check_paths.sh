...
# PATH: /api/wrappers/bash/check_paths.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/validate/check_paths.php

set -euo pipefail

SCRIPT_NAME="check_paths"
SCRIPT_PATH="api/validate/check_paths.php"
