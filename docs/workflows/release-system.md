...
4. Commit and push to main:
   ...
   git commit -m "chore: bump version to 04.00.04"
...
1. **Start Development**:
   ...
   - Run workflow with action: `start-release`, version: `04.00.04`
   - This creates `dev/04.00.04` branch

2. **Create Release Candidate**:
   - Make and test changes in `dev/04.00.04`
   - Run workflow with action: `create-rc`, version: `04.00.04`
   - This creates `rc/04.00.04` branch and `v04.00.04-rc` tag

3. **Finalize Release**:
   - Test RC thoroughly
   - Run workflow with action: `finalize-release`, version: `04.00.04`
   - This creates `version/04.00.04` branch, merges to main, and creates final release
...
- Examples:
  - `04.00.04` - Stable release
  - `04.00.04-rc1` - Release candidate
  - `04.00.04-beta.1` - Beta release
  - `04.00.04-alpha` - Alpha release
