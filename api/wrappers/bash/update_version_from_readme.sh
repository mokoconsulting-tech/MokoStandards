...
# PATH: /api/wrappers/bash/update_version_from_readme.sh
# VERSION: 04.00.15
# BRIEF: Bash wrapper for api/maintenance/update_version_from_readme.php

set -euo pipefail

SCRIPT_NAME="update_version_from_readme"
SCRIPT_PATH="api/maintenance/update_version_from_readme.php"
